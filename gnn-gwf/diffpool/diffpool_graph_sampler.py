...
class diffpool_GraphSampler(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {'adj':adj_padded,
                'feats':self.feature_all[idx], #self.feature_all[idx].copy(),
                'label':self.label_all[idx],
                'num_nodes': num_nodes,
                'assign_feats':self.assign_feat_all[idx]}#self.assign_feat_all[idx].copy()}