...
def read_graphfile(datadir, dataname, max_nodes=None):
    ...
    '''
    prefix = os.path.join(datadir, dataname, dataname, 'raw', dataname)
    ...
    try:
        ...
        node_labels = node_labels - min(node_labels)
    ...
    # if num_unique_node_labels is not None:
    #     print("number of unique node labels is", num_unique_node_labels)
