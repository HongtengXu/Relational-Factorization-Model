...
# joint training
        if args.gnn_weights:
            parameters = list(model.gnn.parameters()) + list(model.atoms.parameters()) + list(model.embeddings.parameters())
        else:
            parameters = [model.weights] + list(model.atoms.parameters()) + list(model.embeddings.parameters())

        optimizer = torch.optim.Adam(parameters, lr = lr)
        optimizer_atoms = torch.optim.Adam(parameters, lr=lr_atoms)
